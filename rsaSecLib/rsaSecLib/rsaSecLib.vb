...
Public Class rsaSecLib
    ...
    Function EncryptString(ByVal DATA As String, ByVal publicKeyXml As String, ByVal keysize As Integer) As String
        Dim rsaCryptoProvider As New RSACryptoServiceProvider(keysize) 'Declare RSA service
    ...
    Function DecryptString(ByVal DATA As String, ByVal privateKeyXml As String, ByVal keysize As Integer) As String
        Dim rsaCryptoProvider As New RSACryptoServiceProvider(keysize) 'Declare RSA service
    ...
    Function EncryptByte(ByVal DATA As Byte(), ByVal publicKeyXml As String, ByVal keysize As Integer) As Byte()
        Dim rsaCryptoProvider As New RSACryptoServiceProvider(keysize) 'Declare RSA service
    ...
    Function DecryptByte(ByVal DATA As Byte(), ByVal privateKeyXml As String, ByVal keysize As Integer) As Byte()
        Dim rsaCryptoProvider As New RSACryptoServiceProvider(keysize) 'Declare RSA service
